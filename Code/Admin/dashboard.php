...
<head>
    ...
    <title>Search for Salon | Admin Dashboard</title>
                                    ...
                                    <div class="col-md-3">
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-success text-light">
                                                <div class="stat-panel text-center">
                                                    <?php
$sql1 ="SELECT id from tblsalons ";
$query1 = $dbh -> prepare($sql1);;
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totalsalon=$query1->rowCount();
?>
                                                    <div class="stat-panel-number h1 "><?php echo htmlentities($totalsalon);?></div>
                                                    <div class="stat-panel-title text-uppercase">Listed Salons</div>
                                                </div>
                                            </div>
                                            <a href="manage-salons.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="panel panel-default">
