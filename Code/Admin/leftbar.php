	<nav class="ts-sidebar">
	    <ul class="ts-sidebar-menu">
	        ...
	        <li><a href="#"><i class="fa fa-map-o"></i> Location</a>
	            <ul>
	                <li><a href="create-location.php">Create Location</a></li>
	                <li><a href="manage-locations.php">Manage Location</a></li>
	            </ul>
	        </li>

	        <li><a href="#"><i class="fa fa-sitemap"></i> Salon</a>
	            <ul>
	                <li><a href="post-salon.php">Post a Salon</a></li>
	                <li><a href="manage-salon.php">Manage Salon</a></li>
	            </ul>
	        </li>
