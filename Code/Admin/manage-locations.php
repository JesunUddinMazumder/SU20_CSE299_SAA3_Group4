...
{
$id=$_GET['del'];
$sql = "delete from tbllocations  WHERE id=:id";
...
<head>
    ...
    <title>Search for Salon |Admin Manage Locations </title>
...
{				?>
                                        <tr>
                                            ...
                                            <td><a href="edit-locations.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
